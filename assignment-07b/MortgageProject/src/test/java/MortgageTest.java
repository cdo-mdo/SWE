...
public class MortgageTest {
	...
	public void testUnder18() {
		LocalDate time17YearsAgo = LocalDate.now().minusYears(17);
		MortgageCalculator mc = new MortgageCalculator();
		double result = mc.computeMaxMortgageSingle(time17YearsAgo.getYear(), time17YearsAgo.getMonthValue(), time17YearsAgo.getDayOfMonth(), 3000, "Architect");
